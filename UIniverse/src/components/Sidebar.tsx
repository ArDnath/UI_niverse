...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <button
        className={cn(
          "md:hidden fixed top-18 left-4 z-50 px-4 py-2 rounded-md",
      ...
      > 
        <PanelLeft className="h-5 w-5 text-gray-700 flex-shrink-0" />
      ...
      <aside
        className={cn(
          ...
          "md:static md:translate-x-0 md:h-[calc(100vh-4rem)] md:border-r md:border-gray-200",
          className
        )}
      ...
      >
        ...
        <div className="p-4 pt-16 md:pt-4 overflow-y-auto h-full">
